...
extension Camera: AVCapturePhotoCaptureDelegate {
    ...
    func photoOutput(_ output: AVCapturePhotoOutput, didFinishProcessingPhoto photo: AVCapturePhoto, error: Error?) {
        ...
        guard let cgImage = uiImage.cgImage else {
            print("Unable to generate cgimge from image data.");
...
//            print("Unable to generate deviceOrientationOnCapture from image data.");
//            //                print("Error retrieving orientation on capture");self.lastPhoto=nil;
//            return
//            
//        }
        
        self.lastPhoto = UIImage(cgImage: cgImage, scale: 1.0, orientation: UIImage.Orientation.up)
