        ...
        Rectangle()
            ...
            .overlay(
                RoundedRectangle(cornerRadius: 19)
                    .inset(by: 1)
                    .stroke(Color(red: 0.87, green: 0.89, blue: 1), lineWidth: 2)
            )
            .overlay {
...
//                                    )
                    ...
                    VStack(alignment: .leading) {
                        ...
                        Text(subtitle ?? "").fontDesign(.rounded).font(.subheadline).fontWeight(.medium).foregroundStyle(.gray)
                        Spacer()
                    }
                    Spacer()
                    
                    Text(time ?? "").fontDesign(.rounded).font(.subheadline).fontWeight(.medium).foregroundStyle(.gray)
                        .padding(.trailing, 16)
                        .padding(.top, 12)
                }
            }
