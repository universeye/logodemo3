...
struct TabModel {
    ...
    static var views: [TabModel] {
        ...
        #else
        let models = [
            TabModel(title: TabText.NotificationAnimation.title, image: TabText.NotificationAnimation.image, destination: NotificationAnimation()),
            ...
            TabModel(title: TabText.FullScreenFadeDemo.title, image: TabText.FullScreenFadeDemo.image, destination: FullScreenFadeDemo()),
            TabModel(title: TabText.splitscreen.title, image: TabText.splitscreen.image, destination: SplitScreenView()),
            TabModel(title: TabText.CustomRefreshView.title, image: TabText.CustomRefreshView.image, destination: CustumRefreshDemo()),
